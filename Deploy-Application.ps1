...
Try {
	...
	[string]$appVendor = 'Kaspersky'
	[string]$appName = 'Endpoint Security'
	[string]$appVersion = '10.2.5.3201'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "setup.exe" -Parameters "/pEULA=1 /pKSN=1 /pALLOWREBOOT=0 /s" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
		...
		Execute-Process -Path "$envProgramFilesX86\Kaspersky Lab\Kaspersky Endpoint Security 10 for Windows SP1\avp.com" -Parameters "UPDATE" -WindowStyle "Hidden" -WaitForMsiExec
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAWwXxbkvzpJlDC
# uSXiMdc6eaNSTOtJtutHzrYP4e7SYKCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIAYB
# rL5illF0cjiHPEvEbGMUcQuTHylqSHVkMxoaHSvvMA0GCSqGSIb3DQEBAQUABIIB
# ADcEBQ6TLujzSl6Z+f5wOZKHkIw20hbkoz2H0O/1mhvuD3FRTe13y2BiQdNr7EjM
# nvPVwYW/wOFtWbC6CgS7Tx0OEq0wxLeTOQSuNBGOHMsdKNDAo8BgvgxYLjEEZNb/
# KyyFKovpNrILQs81k3eKAb/1ybbJ7P6oNV9V/Hyq4TjBEFQ5U+CaMKA2pG7hJmEt
# d+VyFWCktPbfdyDkBMBwYPwY43qDZVUGXMdqwOekruXgorddB1C5GZ1VtozUXq7n
# ZgZBvpu+GkU/Qa5bWIxuW1fEwUfFON3GanITtIN54g6FPoSuhu/nwaBE8Vca5ehP
# iMktgZOQBZn9zBjuAfbHwwWhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwNjE0MjMwMTA3WjAjBgkqhkiG9w0BCQQxFgQU
# YVuQZ8uaUm6P67lLI8jdaE18B8UwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBACJs6P5aQRfBIydqAXac/8MHe62c59UB7wf4JUBcAbahoVdduCeoNk5n
# 4GfgIHdL7tS1I/LCZytN7b8npcI5ay+bVVepHHO41PbPxOJjYkJNghjUC/SXInI/
# yjeih8tGmxA12wWflmBZ8s+oRTmEsNw8CDVVcBuR+XV6iy6fIGY3/dVQV8PTsdgn
# mS1OoQrTWgKUTvCV42PvFHuSEvBoBEHk3vPQT3wGxYgsP9zQAFXZ+DiCxm3NQ6vk
# hs45aBwQIbCOxpARg/oQepO8puZ8vIN6cV8hZ89PJq/CyE55AWMZlJOJo+J/8hPh
# kQFqsCrLOogZmYLw+DQHlhgLP0A6ncw=
